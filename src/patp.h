...
// (1 syllable), stars (2 syllables, no dash), and planets (4 syllables,
// dash between pairs). Output is sized to the wire ship-rank: 2 bytes for
// galaxy/star, 4 bytes for planet. Returns false on shape mismatch or
// unrecognized syllables; moons and comets are not yet supported.
